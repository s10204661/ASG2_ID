...
$(document).ready(function () {
  ...
  const APIKEY = "62c52e2d03ab3e0c7b0cf11e";
  getContacts();
  ...
  $("#contact-submit").on("click", function (e) {
    ...
    let settings = {
      "async": true,
      "crossDomain": true,
      "url": "https://interactivedev-69de.restdb.io/rest/contact",
  ...
  function updateForm(id, contactName, contactEmail, contactMsg) {
    ...
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": `https://interactivedev-69de.restdb.io/rest/contact/${id}`,//update based on the ID
      "method": "PUT",
      "headers": {
        "content-type": "application/json",
        "x-apikey": APIKEY,
